...
gatkJarPath="${HOME}/GenomeAnalysisTK-3.8-1-0-gf15c1c3ef/GenomeAnalysisTK.jar"
...
module load java
java -XX:+UseParallelGC -XX:ParallelGCThreads=${threadsGC} -jar $gatkJarPath -R $ref -T HaplotypeCaller -I $bam -nct ${nct} -o $vcf
